...
function Show() {
	show1.innerText =
		"We'll keep in touch via updates to your order, and to plan the item's delivery with you";
...
function verify() {
	...
	if (address1.value.length === 0) {
		address_valid.innerText =
			"Please Enter a Valid Address. Special characters allowed are ( - , . / ) ' +";
